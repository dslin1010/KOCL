...
int ecryptfs_write2(struct file *file, struct inode *inode, char *data, loff_t offset, size_t size);
int ecryptfs_read2(struct file *file, char *data, loff_t offset, size_t size);
